...
public class BlueBoid : MonoBehaviour {
    ...
    void OnCollisionEnter(Collision col)
    {
        if (col.gameObject.name.Contains("Green"))
        {
            ...
            Debug.Log("new blue at: " + killed.position);
            Instantiate(newBlue, killed.position, Quaternion.identity);
    ...
    Vector3 avoidWalls()
    {
        ...
        Debug.Log("wall avoidance: " + avoid);
        return avoid;
    }
